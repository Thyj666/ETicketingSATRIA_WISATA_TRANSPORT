...
class DatabaseMigration
{
    ...
    private function getEntityMigrations(): array
    {
        return [
            ...
            '005_create_armada'     => \Domain\Entities\Master\Armada\ArmadaEntity::class,
            '006_create_tikets'     => \Domain\Entities\Transaction\Tiket\TiketEntity::class,
            '007_create_pemesanans' => \Domain\Entities\Transaction\Pemesanan\PemesananEntity::class,
        ];
    }
