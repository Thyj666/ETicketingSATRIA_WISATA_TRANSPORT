                    ...
                    <?php foreach ($list as $i => $a): ?>
                        <tr>
                            ...
                            <td class="td-action">
                                ...
                                <form method="POST" action="<?= url('/master/armada/delete') ?>" data-confirm="Armada <?= htmlspecialchars($a->getNamaArmada()) ?> akan dihapus secara permanen." data-confirm-title="Hapus Armada?" data-confirm-icon="🚌" data-confirm-btn="Ya, Hapus" style="display:inline">
